...
export type CatalogCourseFragment = { __typename: 'Course', id: string, denomination: string, slug: string, level: CourseLevel, image?: string | null, rating: number, participationCount: number, instructor: { __typename: 'Teacher', id: string, first_name?: string | null, last_name?: string | null, avatar_url?: string | null } };

export type CatalogProgramFragment = { __typename: 'Program', id: string, denomination: string, slug: string, image?: string | null, enrolledLearnersCount: number, programLevel: ProgramLevel, instructor: { __typename: 'Teacher', id: string, first_name?: string | null, last_name?: string | null, avatar_url?: string | null }, currentVersion: { __typename: 'ProgramVersion', courses: Array<{ __typename: 'Course', id: string }> } };
...
export type CatalogQuery = { __typename: 'Query', subjectsWithLinkedContent: Array<{ __typename: 'Subject', id: string, denomination: string }>, teachers: { __typename: 'TeachersPaginatedResult', items: Array<{ __typename: 'Teacher', id: string, first_name?: string | null, last_name?: string | null, avatar_url?: string | null, followersCount: number, subjects: Array<{ __typename: 'Subject', id: string, denomination: string }> }> }, topContent: { __typename: 'ContentPaginatedResult', items: Array<
      | { __typename: 'Course', id: string, denomination: string, slug: string, level: CourseLevel, image?: string | null, rating: number, participationCount: number, instructor: { __typename: 'Teacher', id: string, first_name?: string | null, last_name?: string | null, avatar_url?: string | null } }
      | { __typename: 'Program', id: string, denomination: string, slug: string, image?: string | null, enrolledLearnersCount: number, programLevel: ProgramLevel, instructor: { __typename: 'Teacher', id: string, first_name?: string | null, last_name?: string | null, avatar_url?: string | null }, currentVersion: { __typename: 'ProgramVersion', courses: Array<{ __typename: 'Course', id: string }> } }
    > } };
...
export type SubjectContentFragment = { __typename: 'Subject', id: string, denomination: string, courses: Array<{ __typename: 'Course', id: string, denomination: string, slug: string, level: CourseLevel, image?: string | null, rating: number, participationCount: number, status: CourseStatus, progress?: { __typename: 'CourseProgress', completedComponents: number, totalComponents: number, progressPercentage: number, isCompleted: boolean } | null, instructor: { __typename: 'Teacher', id: string, first_name?: string | null, last_name?: string | null, avatar_url?: string | null } }>, programs: Array<{ __typename: 'Program', id: string, denomination: string, slug: string, level: ProgramLevel, image?: string | null, enrolledLearnersCount: number, instructor: { __typename: 'Teacher', id: string, first_name?: string | null, last_name?: string | null, avatar_url?: string | null }, currentVersion: { __typename: 'ProgramVersion', courses: Array<{ __typename: 'Course', id: string }> } }> };
