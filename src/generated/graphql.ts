...
export type CourseSectionFragment = { __typename: 'CourseSection', id: string, denomination: string, is_published: boolean, rank: number, items: Array<
    | { __typename: 'Lesson', id: string, itemId: string, denomination: string, duration: number, is_published: boolean, components: Array<
      ...
      > }
    | { __typename: 'Quiz', id: string, itemId: string, denomination: string, is_published: boolean, passing_score: number, max_attempts: number, navigation_mode: QuizNavigationMode, questions_per_page: number, show_correct_answers: boolean, feedback_passed?: string | null, feedback_failed?: string | null, passed?: boolean | null, attempts: Array<{ __typename: 'QuizAttempt', id: string, attempt_number: number, status: QuizAttemptStatus, score?: number | null, passed?: boolean | null, timed_out: boolean, submitted_at?: any | null }> }
  > };
